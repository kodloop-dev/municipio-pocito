  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5">
        ...
        <div>
          <p className="text-white text-[13px] font-black leading-tight tracking-[0.12em]">Santa Lucía</p>
          <p className="text-white/65 text-[10px] font-medium leading-none mt-0.5">Municipalidad · App Vecinal</p>
        </div>
      </div>
